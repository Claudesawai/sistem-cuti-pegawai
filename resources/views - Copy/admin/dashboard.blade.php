        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">
                    <i class="bi bi-clock-history me-2"></i>Pengajuan Cuti Terbaru
                </h5>
            ...
            <div class="card-body p-0">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>Data pengajuan cuti akan muncul di sini</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-pie-chart me-2"></i>Statistik Cuti
                </h5>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="text-muted">Disetujui</span>
                    <span class="badge badge-success">{{ $cutiDisetujui }}</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="text-muted">Ditolak</span>
                    <span class="badge badge-danger">{{ $cutiDitolak }}</span>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-muted">Menunggu</span>
                    <span class="badge badge-warning">{{ $cutiMenunggu }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('admin.cuti.index') }}" class="btn btn-outline-success w-100 mb-2">
